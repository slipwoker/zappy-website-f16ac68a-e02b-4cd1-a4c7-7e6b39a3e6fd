  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (form) {
      ...
      form.addEventListener('submit', function(e) {
        ...
        fields.forEach(function(field) {
          ...
          if (field.hasAttribute('minlength') && field.value.trim()) {
            var min = parseInt(field.getAttribute('minlength'));
      ...
      function showSuccess(formEl, message) {
        var existing = formEl.querySelector('.success-message');
        if (existing) existing.remove();
        
        var successEl = document.createElement('div');
        successEl.className = 'success-message';
        successEl.textContent = message;
        successEl.style.cssText = 'background: #48bb78; color: #fff; padding: 1rem; border-radius: 0.25rem; margin-top: 1rem; text-align: center;';
    ...
    var animatedElements = document.querySelectorAll('.fade-in, .animate-on-scroll');
    ...
    if (animatedElements.length > 0) {
      ...
      style.textContent = '.fade-in.visible, .animate-on-scroll.visible { opacity: 1 !important; transform: translateY(0) !important; }';
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'f16ac68a-e02b-4cd1-a4c7-7e6b39a3e6fd',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'f16ac68a-e02b-4cd1-a4c7-7e6b39a3e6fd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f16ac68a-e02b-4cd1-a4c7-7e6b39a3e6fd';
